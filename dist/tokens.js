...
export const ColorJuiceGuarana = "#df2114";
export const ColorJuiceIcetea = "#7b4e80";
...
export const ColorSurfaceGlassy = "#ffffff66";
...
export const PanelBackgroundTransparent = "#ffffff66";
...
export const TileGlassyBackgroundDefault = "#ffffff66";
...
export const SnackbarBorderColorErro = "#de6565";
export const SnackbarBorderColorSuccess = "#afc33b";
export const SnackbarTextColorInfo = "#ffffff";
export const SnackbarTextColorWarning = "#ffffff";
export const SnackbarTextColorErro = "#ffffff";
export const SnackbarTextColorSuccess = "#ffffff";
...
export const TextFluidSmall = "clamp(0.833rem, 0.78rem + 0.25vw, 0.889rem)";
export const TextFluidDefault = "clamp(1rem, 0.93rem + 0.35vw, 1.111rem)";
export const TextFluidLarge = "clamp(1.15rem, 1.05rem + 0.5vw, 1.333rem)";
export const TextFluidExtraLarge = "clamp(1.5rem, 1.3rem + 1vw, 2rem)";
export const TextFluidHuge = "clamp(1.8rem, 1.5rem + 1.5vw, 2.667rem)";
export const TextFluidExtraHuge = "clamp(2.2rem, 1.7rem + 2.5vw, 4rem)";
...
export const MenuFlyoutTextWhite = "#ffffff";
export const MenuFlyoutTextHover = "#afc33b";
export const MenuFlyoutTextSelected = "#d0e646";
export const MenuFlyoutBackgroundFlyoutGradientFrom = "#d0e646";
export const MenuFlyoutBackgroundFlyoutGradientTo = "#5c6814";
...
export const LinkDefaultTextLabel = "#afc33b";
export const LinkDefaultTextHover = "#8fa02a";
export const LinkGlassyTextLabel = "#ffffff";
export const LinkGlassyTextHover = "#272727";
export const ChipTextColorDefault = "#afc33b";
export const ChipTextColorHover = "#8fa02a";
export const ChipBackgroundEnabled = "#ffffff";
export const ChipBackgroundDisabled = "#dfdfdf";
export const ChipBackgroundHover = "#eeeeee";
export const ChipBackgroundChecked = "#d9ab29";
export const ChipBorderColorDefault = "#afc33b";
export const ChipBorderColorHover = "#8fa02a";
export const ChipRadius = "50px";
export const ChipGlassyTextColorDefault = "#ffffff";
export const ChipGlassyTextColorHover = "#272727";
export const ChipGlassyBackgroundEnabled = "#ffffff66";
export const ChipGlassyBackgroundDisabled = "#dfdfdf";
export const ChipGlassyBackgroundHover = "#eeeeee";
export const ChipGlassyBackgroundChecked = "#d9ab29";
export const ChipGlassyBorderColorDefault = "#afc33b";
export const ChipGlassyBorderColorHover = "#8fa02a";
export const SpaceFluidTiny = "clamp(0.25rem, 0.2rem + 0.3vw, 0.5rem)";
export const SpaceFluidSmall = "clamp(0.5rem, 0.4rem + 0.5vw, 1rem)";
export const SpaceFluidDefault = "clamp(1rem, 0.85rem + 0.75vw, 1.5rem)";
export const SpaceFluidLarge = "clamp(1.5rem, 1.2rem + 1.2vw, 2rem)";
export const SpaceFluidHuge = "clamp(2rem, 1.6rem + 1.8vw, 2.5rem)";
export const SpaceFluidHuge2 = "clamp(2.5rem, 2rem + 2.5vw, 4rem)";
export const LayoutBreakpointTablet = "768px";
export const LayoutBreakpointDesktop = "1024px";
export const LayoutBreakpointDesktopWide = "1440px";
